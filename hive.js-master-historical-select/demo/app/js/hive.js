...
var ByteBuffer = dcodeIO.ByteBuffer,
    ...
    Delfrag = protoFile.build("Delfrag"),
...
ObjectIndex = function() {
    ...
    return b.channel = a, b.pendingRequests = {}, b.inMsg = null, b.outMsg = null, b.pendingOutRequests = [], b.sendHave = function(a) {
    ...
    },  b.sendDelete = function(fragmentId) {
        ...
        switch (c.msgId) {
            ...
            case Transport.MsgTypes.Pong:
                ...
                break;
            case Transport.MsgTypes.Delfrag:
    ...
    return a.renderPeers = function() {
       ...
       if (debugPram == 1){
        ...
        var p = new Promise(function(resolve,reject){
            ...
            setTimeout(function(){ reject("time out in ping")}, 200);
        ...
        return p;
    }, a.sendDelfrag = function(fragmentId){
